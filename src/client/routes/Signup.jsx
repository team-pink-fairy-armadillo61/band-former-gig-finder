    ...
    <div className='wrap-container'>
      ...
      <div className='inner'>
        <form>
          ...
          <input type='text' placeholder='user name' required></input><br />
          ...
          <input type='text' placeholder='Enter your city'></input><br />
          ...
          <textarea placeholder='Enter your short bio here' /><br />
          ...
          <input type='text' placeholder='Enter your link here'></input><br />

          <label htmlFor='video_url'>Profile page video URL</label><br />
          <input type='text' placeholder='Enter embeded link here'></input><br />
